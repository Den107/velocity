...
import {clearBascket} from "../redux/features/bascketSlice";
...
const Cart = () => {
    ...
    const totalPrice = () =>{
        return items.reduce((acc, item) => {
            return acc + +item.price.split(' ').join('')
        }, 0)
    }
                    ...
                    <div className="cart">
                        <div className="cart__top">
                            ...
                            <div className="cart__clear">
                                ...
                                <span onClick={clearTrash}>Очистить корзину</span>
                            </div>
                        </div>
                        <div className="content__items">
                            ...
                            {/*        <img*/}
                            {/*            className="pizza-block__image"*/}
                            {/*            src="../assets/images/content/Bicycle1.png"*/}
                            {/*            alt="velo"*/}
                            {/*        />*/}
                            {/*    </div>*/}
                            {/*    <div className="cart__item-info">*/}
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                <span> Всего товаров: <b>{items.length} шт.</b> </span>
                            ...
                            <div className="cart__bottom-buttons">
                                ...
                                <div onClick={()=>alert(`Спасибо за заказ!
                                Сумма вашего заказа ${totalPrice()} рублей
                                `)}

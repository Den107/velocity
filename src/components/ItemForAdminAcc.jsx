...
const Item = ({title, price, imageUrl, deleteAcc, _id, updateAcc}) => {
    ...
    return (
        <div className="product-item__wrapper ">
            ...
            <button onClick={()=>deleteAcc(_id)} className="product-item__bascket  bg-white rounded-none bottom-1 right-1">
                <img className={'h-full'} src="assets/images/trash.svg" alt="bascket"/>
            </button>
            <button onClick={()=>updateAcc(_id)} className="product-item__bascket   rounded-none bg-white bottom-1 left-1">

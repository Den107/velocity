...
const Item = ({title, price, imageUrl, deleteVelo, _id, updateVelo}) => {
    ...
    return (
        <div className="product-item__wrapper ">
            ...
            <button onClick={()=>deleteVelo(_id)} className="product-item__bascket  bg-white rounded-none bottom-1 right-1">
                <img className={'h-full'} src="assets/images/trash.svg" alt="bascket"/>
            </button>
            <button onClick={()=>updateVelo(_id)} className="product-item__bascket   rounded-none bg-white bottom-1 left-1">
